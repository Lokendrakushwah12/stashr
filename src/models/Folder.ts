...
// Compound index to ensure unique folder names per team
folderSchema.index({ teamId: 1, name: 1 }, { unique: true, sparse: true });

export default (mongoose.models.Folder as FolderModel) ??
